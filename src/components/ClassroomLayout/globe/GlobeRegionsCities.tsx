...
import { FEATURED_CITY_IDS } from './data/featured';
 ...
 * City objects. Reuses existing curation so all 18 regions are covered.
 */
function regionCities(regionId: string): City[] {
