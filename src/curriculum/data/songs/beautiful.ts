  ...
  sections: [
    {
      ...
      bars: [
        ...
        {
          chords: [
            { degree: '1 maj', chordName: 'E♭/B♭', beat: 1, duration: 4 },
          ],
        },
        {
          chords: [{ degree: '1 maj', chordName: 'A♭', beat: 1, duration: 4 }],
        ...
        {
          chords: [
            { degree: '1 maj', chordName: 'E♭dim7/B♭', beat: 1, duration: 4 },
          ],
        },
        {
          chords: [
    ...
    },
    {
      ...
      bars: [
        ...
        {
          chords: [
            { degree: '1 maj', chordName: 'C♯min7/B', beat: 1, duration: 4 },
          ],
        },
        {
          chords: [
            { degree: '1 maj', chordName: 'C♯min7/A♯', beat: 1, duration: 4 },
          ],
        },
        { chords: [{ degree: '1 maj', chordName: 'A', beat: 1, duration: 4 }] },
        {
    ...
    },
    {
      ...
      bars: [
        ...
        {
          chords: [
            { degree: '1 maj', chordName: 'F♯7/A♯', beat: 1, duration: 4 },
          ],
        },
        { chords: [{ degree: '1 maj', chordName: 'A', beat: 1, duration: 4 }] },
        {
