...
export const ITEMS: Record<string, Item> = {
  ...
  SNARE: {
    ...
    icon: Circle,
    iconSize: 18,
    iconClassName: 'border-2 rounded-full',
    description: 'SM57 Mic',
  },
  HIHAT: {
    id: 'hihat',
    name: 'Hi-Hats',
    ...
    icon: Disc,
    iconSize: 18,
    description: 'Small Diaphragm Condenser',
  },
  RACK_TOM: {
    id: 'rack_tom',
    name: 'Rack Tom',
  ...
  SNAKE_BOX: {
    ...
    type: 'equipment',
    icon: Layers,
    description: '16-Channel Stage Box',
  },
  ...
  SNAKE_MULTI: {
    id: 'snake_multi',
    name: 'Multicore Snake',
    type: 'cable',
    icon: Cable,
    color: 'purple',
    iconClassName: 'text-purple-400',
    description: 'Multi-channel Trunk',
  },
};
...
export const LEVELS: Level[] = [
  ...
  },
  {
    ...
    brief:
      'Route the vocal mic to the mixer, then split the signal to FOH Mains and Stage Monitors.',
    slots: [
      {
        id: 'slot_mic',
        type: 'equipment',
  ...
  },
  {
    ...
    brief:
      'Wire the full drum kit into the stage snake, then run the multicore to FOH and route returns to monitors.',
    slots: [
      {
        id: 'slot_kick',
        type: 'equipment',
