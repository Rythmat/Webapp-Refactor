 ...
 * inside the Learn section — an animated grid-rows accordion, so the icons below
 * slide rather than jump; off Learn it collapses to just the Learn icon.
 *
...
export const SidebarLearnGroup = () => {
  ...
  const homeActive = open && activeTab === ''; // Learn icon == the Home entry
