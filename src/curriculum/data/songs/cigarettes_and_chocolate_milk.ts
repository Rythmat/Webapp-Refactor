  ...
  sections: [
    ...
    },
    {
      ...
      bars: [
        ...
        {
          chords: [
            { degree: '1 maj', chordName: 'F♯min7/C♯', beat: 1, duration: 4 },
          ],
        },
        {
    ...
    },
    {
      ...
      bars: [
        ...
        {
          chords: [{ degree: '1 maj', chordName: 'F♯m', beat: 1, duration: 4 }],
        },
        {
          chords: [
            { degree: '1 maj', chordName: 'Emin7', beat: 1, duration: 4 },
    ...
    },
    {
      ...
      bars: [
        ...
        { chords: [{ degree: '1 maj', chordName: 'B', beat: 1, duration: 4 }] },
        {
          chords: [{ degree: '1 maj', chordName: 'F/B', beat: 1, duration: 4 }],
        },
        { chords: [{ degree: '1 maj', chordName: 'E', beat: 1, duration: 4 }] },
        {
    ...
    },
    {
      ...
      bars: [
        ...
        { chords: [{ degree: '1 maj', chordName: 'E', beat: 1, duration: 4 }] },
        {
          chords: [{ degree: '1 maj', chordName: 'B/E', beat: 1, duration: 4 }],
        },
        { chords: [{ degree: '1 maj', chordName: 'B', beat: 1, duration: 4 }] },
        {
          chords: [
