/**
 * epSamplerV2.ts — Sample-accurate EP1 sampler for genre curriculum backing tracks.
 *
 * Copy of src/audio/epSampler.ts with one addition: optional `time` parameter
 * on triggerEpAttackRelease so it can be scheduled inside Tone.Part callbacks.
 *
 * We don't modify Aaron's original — this lives in our engine folder.
 */
