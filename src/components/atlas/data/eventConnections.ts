...
const EVENT_CONNECTIONS: EventConnection[] = [
  ...
  { from: 'evt-pop-nyc-1999-britneyspears', to: 'song-jack_diane' },
  { from: 'evt-pop-orlando-1995-nsync', to: 'song-jack_diane' },
  ...
  { from: 'evt-hiphop-portsmouth-1997-missyelliott', to: 'song-suit_tie' },
  { from: 'evt-jamband-sandiego-1998-kdtu', to: 'song-suit_tie' },
