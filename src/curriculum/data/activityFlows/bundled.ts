/**
 * The bundled lesson data — 14 genres x 3 levels, plus Piano Fundamentals.
 *
 * No longer the runtime source of truth: published lessons are fetched from the
 * CDN by src/content/flowStore.ts, which imports this module DYNAMICALLY as its
 * fallback. Keep that dynamic.
 *
