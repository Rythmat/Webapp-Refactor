...
export const MUSIC_HISTORY: HistoricalEvent[] = [
  ...
  // ── Phase 6: Electronic Music's Transatlantic Journey (1982–1998) ──
  {
    ...
    description:
      "Drawing on disco, Philly soul, and European synth-pop, Frankie Knuckles forged house music at the Warehouse, layering drum machines over soulful vocals to keep the dancefloor alive after disco's commercial death. Chicago house would become the blueprint for acid house in London, rave culture across Europe, and eventually the global EDM explosion of the 2010s.",
    tags: [
      'house',
      'frankie knuckles',
      'warehouse',
  ...
  },
  {
    ...
    description:
      'Turkish musicians fuse Anatolian folk melodies, bağlama saz, and makam scales with fuzz guitars, wah-wah pedals, and psychedelic rock energy. Barış Manço, Erkin Koray, and Cem Karaca create a uniquely Turkish psychedelic sound that influences Middle Eastern rock for decades.',
    tags: [
      'barış manço',
      'erkin koray',
      'cem karaca',
  ...
  },
  {
    ...
    description:
      "Tehran's pre-revolution pop scene explodes with Googoosh, the biggest pop star in the Persian-speaking world. Iranian artists blend dastgah classical modes with funk, disco, and rock. The 1979 revolution silences the scene overnight, scattering Iranian musicians into global diaspora.",
    tags: [
      'googoosh',
      'iranian pop',
      'dastgah',
