  ...
  sections: [
    ...
    },
    {
      ...
      bars: [
        ...
        {
          chords: [
            { degree: '1 maj', chordName: 'G♯min/G', beat: 1, duration: 4 },
          ],
        },
        { chords: [{ degree: '1 maj', chordName: 'F', beat: 1, duration: 4 }] },
        {
          chords: [
            { degree: '1 maj', chordName: 'G♯min/F♯', beat: 1, duration: 4 },
          ],
        },
        {
          chords: [
    ...
    },
    {
      ...
      bars: [
        ...
        {
          chords: [
            { degree: '1 maj', chordName: 'A♯min/A', beat: 1, duration: 4 },
          ],
        },
        {
          chords: [
            { degree: '1 maj', chordName: 'A♯min/G♯', beat: 1, duration: 4 },
          ],
        },
        {
          chords: [
