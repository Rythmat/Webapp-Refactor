...
export const CITY_COUNTRY_TO_ISO: Record<string, string> = {
  'US': 'USA', 'UK': 'GBR', 'Germany': 'DEU', 'France': 'FRA',
  'Jamaica': 'JAM', 'Cuba': 'CUB', 'Brazil': 'BRA', 'Nigeria': 'NGA',
  'India': 'IND', 'Japan': 'JPN', 'Austria': 'AUT', 'Argentina': 'ARG',
  'Ghana': 'GHA', 'South Africa': 'ZAF', 'South Korea': 'KOR',
  'Portugal': 'PRT', 'Spain': 'ESP', 'Sweden': 'SWE', 'Morocco': 'MAR',
  'Puerto Rico': 'PRI', 'Colombia': 'COL', 'Senegal': 'SEN', 'Egypt': 'EGY',
  'Mexico': 'MEX', 'Angola': 'AGO', 'China': 'CHN', 'Kenya': 'KEN',
  'Lebanon': 'LBN', 'Hungary': 'HUN', 'Russia': 'RUS', 'Uzbekistan': 'UZB',
  'Turkey': 'TUR', 'Ethiopia': 'ETH', 'Australia': 'AUS', 'Algeria': 'DZA',
  'Tunisia': 'TUN', 'Libya': 'LBY', 'Sudan': 'SDN', 'Mali': 'MLI',
  'Burkina Faso': 'BFA', "Côte d'Ivoire": 'CIV', 'Guinea': 'GIN',
  'Guinea-Bissau': 'GNB', 'Sierra Leone': 'SLE', 'Liberia': 'LBR',
  'Togo': 'TGO', 'Benin': 'BEN', 'Niger': 'NER', 'Mauritania': 'MRT',
  'Gambia': 'GMB', 'Cape Verde': 'CPV', 'DR Congo': 'COD',
  'Republic of Congo': 'COG', 'Cameroon': 'CMR', 'Gabon': 'GAB',
  'Equatorial Guinea': 'GNQ', 'Central African Republic': 'CAF',
  'Chad': 'TCD', 'São Tomé and Príncipe': 'STP', 'Tanzania': 'TZA',
  'Uganda': 'UGA', 'Rwanda': 'RWA', 'Burundi': 'BDI', 'Somalia': 'SOM',
  'Eritrea': 'ERI', 'Djibouti': 'DJI', 'South Sudan': 'SSD',
  'Madagascar': 'MDG', 'Comoros': 'COM', 'Mauritius': 'MUS',
  'Seychelles': 'SYC', 'Mozambique': 'MOZ', 'Zimbabwe': 'ZWE',
  'Zambia': 'ZMB', 'Malawi': 'MWI', 'Botswana': 'BWA', 'Namibia': 'NAM',
  'Eswatini': 'SWZ', 'Lesotho': 'LSO', 'Norway': 'NOR', 'Finland': 'FIN',
  'Denmark': 'DNK', 'Iceland': 'ISL', 'Ireland': 'IRL',
  'Netherlands': 'NLD', 'Belgium': 'BEL', 'Luxembourg': 'LUX',
  'Switzerland': 'CHE', 'Italy': 'ITA', 'Monaco': 'MCO',
  'Liechtenstein': 'LIE', 'Andorra': 'AND', 'San Marino': 'SMR',
  'Malta': 'MLT', 'Vatican City': 'VAT', 'Poland': 'POL', 'Czechia': 'CZE',
  'Slovakia': 'SVK', 'Romania': 'ROU', 'Bulgaria': 'BGR', 'Croatia': 'HRV',
  'Serbia': 'SRB', 'Bosnia and Herzegovina': 'BIH', 'Montenegro': 'MNE',
  'North Macedonia': 'MKD', 'Albania': 'ALB', 'Slovenia': 'SVN',
  'Ukraine': 'UKR', 'Belarus': 'BLR', 'Moldova': 'MDA', 'Greece': 'GRC',
  'Cyprus': 'CYP', 'Lithuania': 'LTU', 'Latvia': 'LVA', 'Estonia': 'EST',
  'Iran': 'IRN', 'Iraq': 'IRQ', 'Syria': 'SYR', 'Jordan': 'JOR',
  'Israel': 'ISR', 'Palestine': 'PSE', 'Saudi Arabia': 'SAU', 'Yemen': 'YEM',
  'Oman': 'OMN', 'UAE': 'ARE', 'Qatar': 'QAT', 'Bahrain': 'BHR',
  'Kuwait': 'KWT', 'Georgia': 'GEO', 'Armenia': 'ARM', 'Azerbaijan': 'AZE',
  'Kazakhstan': 'KAZ', 'Kyrgyzstan': 'KGZ', 'Tajikistan': 'TJK',
  'Turkmenistan': 'TKM', 'Pakistan': 'PAK', 'Bangladesh': 'BGD',
  'Sri Lanka': 'LKA', 'Nepal': 'NPL', 'Bhutan': 'BTN', 'Maldives': 'MDV',
  'Afghanistan': 'AFG', 'Mongolia': 'MNG', 'North Korea': 'PRK', 'Taiwan': 'TWN',
  'Myanmar': 'MMR', 'Thailand': 'THA', 'Vietnam': 'VNM', 'Laos': 'LAO',
  'Cambodia': 'KHM', 'Malaysia': 'MYS', 'Singapore': 'SGP',
  'Indonesia': 'IDN', 'Philippines': 'PHL', 'Timor-Leste': 'TLS',
  'Brunei': 'BRN', 'New Zealand': 'NZL', 'Papua New Guinea': 'PNG',
  'Fiji': 'FJI', 'Solomon Islands': 'SLB', 'Vanuatu': 'VUT',
  'Samoa': 'WSM', 'Tonga': 'TON', 'Kiribati': 'KIR', 'Micronesia': 'FSM',
  'Marshall Islands': 'MHL', 'Palau': 'PLW', 'Nauru': 'NRU',
  'Tuvalu': 'TUV', 'Canada': 'CAN', 'Haiti': 'HTI',
  'Dominican Republic': 'DOM', 'Trinidad and Tobago': 'TTO',
  'Barbados': 'BRB', 'Bahamas': 'BHS', 'Grenada': 'GRD',
  'Saint Lucia': 'LCA', 'Saint Vincent and the Grenadines': 'VCT',
  'Dominica': 'DMA', 'Antigua and Barbuda': 'ATG',
  'Saint Kitts and Nevis': 'KNA', 'Belize': 'BLZ', 'Guatemala': 'GTM',
  'Honduras': 'HND', 'El Salvador': 'SLV', 'Nicaragua': 'NIC',
  'Costa Rica': 'CRI', 'Panama': 'PAN', 'Venezuela': 'VEN',
  'Ecuador': 'ECU', 'Peru': 'PER', 'Bolivia': 'BOL', 'Chile': 'CHL',
