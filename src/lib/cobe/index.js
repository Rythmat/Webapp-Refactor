...
function Y(e, t, r) {
  let a = Re(e, e.VERTEX_SHADER, t),
    o = Re(e, e.FRAGMENT_SHADER, r);
  if (!a || !o) return null;
  ...
  return (
    ...
    e.getProgramParameter(i, e.LINK_STATUS)
      ? (e.deleteShader(a), e.deleteShader(o), i)
      ...
      m: function (e, r) {
        ...
        for (let n of e) {
          ...
          (o[e] = 1),
            ...
            f.visible
              ? (a['--cobe-visible-' + e] = 'N')
              : delete a['--cobe-visible-' + e];
        }
        for (let e in t)
          o[e] || (t[e].remove(), delete t[e], delete a['--cobe-visible-' + e]);
      },
      a: function (e, t) {
        let o = {};
        for (let n of e) {
          ...
          (o[e] = 1),
            i(r, e, '--cobe-arc-' + e, f),
            f.visible
              ? (a['--cobe-visible-arc-' + e] = 'N')
              : delete a['--cobe-visible-arc-' + e];
        }
        for (let e in r)
          o[e] ||
            (r[e].remove(), delete r[e], delete a['--cobe-visible-arc-' + e]);
      },
      r: function () {
...
var { PI: Z, sin: le, cos: _e } = Math,
  ...
  ge =
    'precision highp float;varying vec2 m;varying vec3 g;varying float h;uniform vec3 v;void main(){if(length(m)>.25)discard;vec3 a=h>.5?g:v;gl_FragColor=vec4(a,1);}',
  Fe =
  ...
  Le =
    'precision highp float;varying vec3 i;varying float j,s,t;uniform vec3 M;void main(){if(s<0.&&t<.8)discard;vec3 a=j>.5?i:M;gl_FragColor=vec4(a,1);}',
  ee = 0.8;
function U([e, t]) {
  let r = (e * Z) / 180,
    a = (t * Z) / 180 - Z,
...
var Pe = (e, t) => {
  let r = {
    ...
    a = e.getContext('webgl2', r),
    o = !!a;
  if ((a || (a = e.getContext('webgl', r)), !a))
    return { destroy: () => {}, update: () => {} };
  let i = o ? null : a.getExtension('ANGLE_instanced_arrays'),
  ...
  let k = a.createBuffer(),
    S = a.createBuffer(),
    I = H(a, w, ['t', 's', 'k', 'x', 'v', 'F', 'w', 'n', 'y', 'z', 'Uc']),
  ...
  if (mt) {
    a.bindTexture(a.TEXTURE_2D, V),
      a.texImage2D(a.TEXTURE_2D, 0, a.RGBA, a.RGBA, a.UNSIGNED_BYTE, mt),
      a.texParameteri(a.TEXTURE_2D, a.TEXTURE_MIN_FILTER, a.NEAREST),
      a.texParameteri(a.TEXTURE_2D, a.TEXTURE_MAG_FILTER, a.NEAREST),
  ...
  function K(e, t, r, n, f) {
    e < 0 ||
      ...
      a.vertexAttribPointer(e, t, a.FLOAT, !1, r, n),
      o ? a.vertexAttribDivisor(e, f) : i && i.vertexAttribDivisorANGLE(e, f));
  }
  let q,
    Z = document.createElement('div');
  (Z.style.cssText = 'position:relative;width:100%;height:100%'),
  ...
  function te(t) {
    if (
      ...
      t.markers &&
        (function (e) {
          ...
          c.forEach((e, r) => {
            ...
            a.bufferData(a.ARRAY_BUFFER, t, a.DYNAMIC_DRAW);
        })(t.markers),
      t.arcs &&
        (function (e) {
          (s = e), (J = s.length);
      ...
      t.width &&
        t.height &&
        ((e.width = t.width * n), (e.height = t.height * n)),
      t.mapSamples != q && (A = t.mapSamples),
      t.mapBrightness != q && (v = t.mapBrightness),
      t.mapBaseBrightness != q && (d = t.mapBaseBrightness),
      t.baseColor != q && (g = t.baseColor),
      t.markerColor != q && (m = t.markerColor),
      t.glowColor != q && (u = t.glowColor),
      t.arcColor != q && (h = t.arcColor),
      t.arcWidth != q && (E = t.arcWidth),
      t.arcHeight != q && (R = t.arcHeight),
      t.diffuse != q && (b = t.diffuse),
      t.dark != q && (x = t.dark),
      t.opacity != q && (y = t.opacity),
      t.offset != q && (T = t.offset),
      t.scale != q && (B = t.scale),
      t.markerElevation != q && (p = t.markerElevation),
      $.m(c, W),
      $.a(s, X),
      $.s(),
      ...
      o ? a.vertexAttribDivisor(M, 0) : i && i.vertexAttribDivisorANGLE(M, 0),
      ...
      a.useProgram(F),
        ...
        G.k >= 0 &&
          ...
          a.vertexAttribPointer(G.k, 2, a.FLOAT, !1, 0, 0),
          o
            ? a.vertexAttribDivisor(G.k, 0)
            : i && i.vertexAttribDivisorANGLE(G.k, 0)),
        a.bindBuffer(a.ARRAY_BUFFER, S);
      let t = 48;
      if (
        (K(G.l, 3, t, 0, 1),
    ...
    if (C && c.length > 0) {
      a.useProgram(C),
        ...
        L.n >= 0 &&
          ...
          a.vertexAttribPointer(L.n, 2, a.FLOAT, !1, 0, 0),
          o
            ? a.vertexAttribDivisor(L.n, 0)
            : i && i.vertexAttribDivisorANGLE(L.n, 0)),
        a.bindBuffer(a.ARRAY_BUFFER, k);
      let t = 32;
      K(L.p, 3, t, 0, 1),
        K(L.q, 1, t, 12, 1),
