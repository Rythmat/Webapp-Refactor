  ...
  return (
      <PianoRoll
        events={[
          ...
          { id: "e1", pitchName: "A2", startBeats: 8, durationBeats: 4 },
          { id: "e2", pitchName: "C3", startBeats: 8, durationBeats: 4 },
          { id: "e3", pitchName: "E3", startBeats: 8, durationBeats: 4 },
          { id: "e4", pitchName: "G3", startBeats: 8, durationBeats: 4 },
          { id: "e5", pitchName: "B3", startBeats: 12, durationBeats: 4 },
          { id: "e6", pitchName: "E3", startBeats: 12, durationBeats: 4 },
          { id: "e7", pitchName: "G3", startBeats: 12, durationBeats: 4 },
          { id: "e8", pitchName: "C3", startBeats: 12, durationBeats: 4 },
        ]}
