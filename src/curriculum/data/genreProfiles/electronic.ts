...
export const electronicProfile: GenreProfile = {
  id: 'electronic',
  displayName: 'Electronic',
  accentColor: '#00ACC1', // NOTE
  tagline: '[NOTE]',
  ...
  levels: {
    1: {
      ...
      mode: '[NOTE]',
      keyMidi: 60, // NOTE
      scaleIntervals: [0, 2, 3, 5, 7, 8, 10], // NOTE — minor
      scaleNotes: [],
      tempoRange: '110–145 BPM', // NOTE
      primaryVoicings: [],
      technique: {
    ...
    2: {
      ...
      mode: '[NOTE]',
      keyMidi: 60, // NOTE
      scaleIntervals: [0, 2, 3, 5, 7, 8, 10], // NOTE
      scaleNotes: [],
      tempoRange: '110–145 BPM', // NOTE
      primaryVoicings: [],
      technique: {
