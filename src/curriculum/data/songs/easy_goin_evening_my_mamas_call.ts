  ...
  sections: [
    {
      ...
      bars: [
        {
          chords: [
            { degree: '1 maj', chordName: 'A♭/E♭', beat: 1, duration: 4 },
          ],
        },
        {
        ...
        {
          chords: [
            { degree: '1 maj', chordName: 'A♭/G', beat: 1, duration: 4 },
          ],
        },
        {
          chords: [
            { degree: '1 maj', chordName: 'B♭min7/G', beat: 1, duration: 4 },
          ],
        },
        {
          chords: [
    ...
    },
    {
      ...
      bars: [
        ...
        {
          chords: [
            { degree: '1 maj', chordName: 'G/B♭', beat: 1, duration: 4 },
          ],
        },
        {
          chords: [
            { degree: '1 maj', chordName: 'F/A♭', beat: 1, duration: 4 },
          ],
        },
    ...
    },
    {
      ...
      bars: [
        ...
        {
          chords: [
            { degree: '1 maj', chordName: 'G♭dim7', beat: 1, duration: 4 },
          ],
        },
        { chords: [{ degree: '1 maj', chordName: 'G', beat: 1, duration: 4 }] },
        { chords: [{ degree: '1 maj', chordName: 'C', beat: 1, duration: 4 }] },
